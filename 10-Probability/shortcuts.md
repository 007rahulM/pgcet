...
- **Basic Probability**: Compute favorable/total after listing mutually exclusive cases only.
- **Compound Events**: Identify the pattern first, then apply its standard formula/method directly for faster elimination.
- **Standard Problems**: Identify the pattern first, then apply its standard formula/method directly for faster elimination.
- **Random Variables**: Identify the pattern first, then apply its standard formula/method directly for faster elimination.
