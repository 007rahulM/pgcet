...
- Business partnership problems with profit sharing
...
- If all partners invest for same time: ratio = ratio of capitals
- If investment times differ: ratio = capital × time for each partner

### Mixture (Alligation Rule):
> To mix two items of different values to get a desired value:
...
1. **Same time partnership:** directly use capital ratio
2. **Different time:** multiply capital × time for each
3. **Alligation:** cross difference method (dearer−mean) : (mean−cheaper)

---

## 📝 Practice Problems

1. A invests ₹8000 for 6 months, B invests ₹6000 for 8 months. Profit ratio?

2. A, B, C invest ₹3000, ₹4000, ₹5000 for 1 year. Profit = ₹3600. B's share?

3. How much water should be added to 20 litres of 80% milk solution to make it 50% milk?

4. A joins a business with ₹12000. After 4 months B joins with ₹16000. After 1 year, profit = ₹11000. Find B's share.
