...
This folder now follows the same pattern-based style as the stronger folders: **recognition clues, formulas, solved examples, practice, and separate answers**.

Quadratics usually appear as direct marks because the question types repeat.
...
- **Write the standard form first:** ax² + bx + c = 0
