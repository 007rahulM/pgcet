...
- **Mean Median Mode**: Identify the pattern first, then apply its standard formula/method directly for faster elimination.
- **Variance And Sd**: Identify the pattern first, then apply its standard formula/method directly for faster elimination.
- **Frequency Distribution**: Identify the pattern first, then apply its standard formula/method directly for faster elimination.
- **Correlation And Regression**: Identify the pattern first, then apply its standard formula/method directly for faster elimination.
- **Skewness And Kurtosis**: Identify the pattern first, then apply its standard formula/method directly for faster elimination.
