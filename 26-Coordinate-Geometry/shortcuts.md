...
- **Coordinate Geometry**: Identify the pattern first, then apply its standard formula/method directly for faster elimination.
- **Lines And Distance**: Normalize units first and use relative speed where motion is opposite/same direction.
- **Circles**: Identify the pattern first, then apply its standard formula/method directly for faster elimination.
- **Conics And Transformations**: Identify the pattern first, then apply its standard formula/method directly for faster elimination.
