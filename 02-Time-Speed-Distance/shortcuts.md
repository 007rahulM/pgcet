...
- **Average Speed**: Use weighted/assumed-mean or replacement-delta method instead of full recomputation.
- **Relative Speed**: Normalize units first and use relative speed where motion is opposite/same direction.
- **Trains**: Identify the pattern first, then apply its standard formula/method directly for faster elimination.
- **Boats And Streams**: Normalize units first and use relative speed where motion is opposite/same direction.
