...
- **Simple Interest**: Use SI linear formula and CI growth-factor form; compare against base principal.
- **Compound Interest**: Use SI linear formula and CI growth-factor form; compare against base principal.
- **Ci Vs Si Comparison**: Identify the pattern first, then apply its standard formula/method directly for faster elimination.
- **Change In Compounding Period**: Identify the pattern first, then apply its standard formula/method directly for faster elimination.
