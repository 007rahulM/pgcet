...
- "One word for 'fear of heights' is..."
- Fill-in-the-blank with appropriate word

---

## 📐 Common Synonyms (Must Know!)
...
| Frugal | Extravagant |
| Verbose | Concise |
| Jubilant | Gloomy, Dejected |

---

## 📐 One-Word Substitutions (Exam Favourites!)
...
| A story or poem about a dead person | Elegy |
...
(A) Lazy  (B) Hardworking  (C) Confused  (D) Silent
...
(A) Unfriendly  (B) Dangerous  (C) Friendly  (D) Angry

- "Hostile" = unfriendly, antagonistic → antonym = friendly
- **Answer: (C) Friendly** ✅
- (Note: Unfriendly is a SYNONYM, not antonym!)

### Example 3 (One-word)
**Q:** "Fear of heights" is:
(A) Hydrophobia  (B) Claustrophobia  (C) Acrophobia  (D) Xenophobia

- Acro = height, phobia = fear → Acrophobia
- **Answer: (C) Acrophobia** ✅

### Example 4 (One-word)
**Q:** "Philatelist" means:
(A) Coin collector  (B) Stamp collector  (C) Art collector  (D) Book collector

- Phil = love, ately/atelic = stamps
- **Answer: (B) Stamp collector** ✅
...
1. Synonym of "eloquent": (A) Quiet (B) Articulate (C) Confused (D) Rude

2. Antonym of "frugal": (A) Thrifty (B) Economical (C) Extravagant (D) Careful

3. One who walks in sleep: (A) Insomniac (B) Somnambulant (C) Somnambulist (D) Hypnotist

4. "Epitaph" is words written on a: (A) Wall (B) Book (C) Tombstone (D) Canvas

5. Synonym of "impede": (A) Help (B) Assist (C) Hinder (D) Accelerate

6. Antonym of "verbose": (A) Wordy (B) Concise (C) Talkative (D) Fluent

7. "Numismatist" is a collector of: (A) Stamps (B) Coins (C) Books (D) Art

8. Synonym of "tenacious": (A) Weak (B) Determined (C) Lazy (D) Confused

9. "Government by one person with absolute power" is: (A) Democracy (B) Oligarchy (C) Autocracy (D) Monarchy

10. Fear of fire is: (A) Pyrophobia (B) Hydrophobia (C) Acrophobia (D) Pyromania
